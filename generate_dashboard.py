...
fig_breadth.add_vline(x=avg_change, line_dash="dash", line_color="#1e293b", line_width=2, 
...
<head>
  ...
  <style>
    ...
    *,*::before,*::after{{box-sizing:border-box;margin:0;padding:0;}}
    ...
    .data-table td{{padding:9px 12px;border-bottom:1px solid #f1f5f9;white-space:nowrap;transition:background 0.15s ease;}}
